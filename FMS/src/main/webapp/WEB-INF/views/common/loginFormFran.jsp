   ...
   <div class="login-box">
      <div class="card-body" style="padding : 7px;" onclick="log();">
          <div class="login-body">
            <form action="<%=request.getContextPath() %>/fr/common/loginFran.do"   method="post">
               ...
               <div>
                  <button type="submit" class="btn bg-gradient-primary btn-block" style="height : calc(2.25rem + 20px);">가맹점로그인</button>
               </div>
            </form>
                  </div>
               </div>
